            ...
            {!hasTasks ? (
              ...
              <div className="space-y-4">
                {Object.entries(groupedTasks).map(([dimLabel, { tasks, color }]) => (
                  <div key={dimLabel}>
                    <div
                      className={`text-[10px] font-bold uppercase tracking-wider mb-1 px-2 text-${color}-500`}
                    >
                      {dimLabel}
                    </div>
                    <div className="space-y-1">
                      {tasks.map((task) => (
                        ...
                        >
                          ...
                          <div>
                            <div className="text-sm text-slate-300 group-hover:text-white line-clamp-1">
                              {task.title}
                            </div>
                            {task.description && (
