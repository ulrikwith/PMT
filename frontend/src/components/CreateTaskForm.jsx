  ...
  const renderStep4 = () => (
    <div className="space-y-4 animate-in slide-in-from-right-4 duration-200">
      ...
      <div>
        ...
        <input
          type="date"
          className="w-full px-4 py-3 bg-slate-900/60 border border-white/10 rounded-lg text-slate-200 placeholder-slate-500 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition-all" // Note: standard date picker styling is browser dependent
          value={dueDate}
